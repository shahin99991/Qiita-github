...
tags:
  ...
  - MicrosoftTeams
private: false
updated_at: "2026-09-02T21:16:54+09:00"
...
つまり、両者は競合というより役割が重なりつつも視点が異なるアプローチです。WorkIQ は Microsoft 365 のエコシステム全体を横断する統合ナレッジ基盤として強力な一方、YJK-AI-Agent は「Teams の会話とGitHubを起点に、社内特有のワークフローをピンポイントで自動化する」ことに振り切った自前実装です。将来的には WorkIQ（または後述の Foundry IQ）をナレッジ層として使いつつ、YJK-AI-Agent 側は GitHub・開発ワークフローに寄せた実行層として組み合わせる構成もあり得ると考えています。
